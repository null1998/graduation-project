...
public class InvoiceVO implements Serializable {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public String getInvoiceVOPeople() {
        return invoicePeople;
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public void setInvoiceVOPeople(String invoicePeople) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public LocalDate getInvoiceVODate() {
        return invoiceDate;
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public void setInvoiceVODate(LocalDate invoiceDate) {
    ...
    public boolean equals(Object that) {
        ...
        InvoiceVO other = (InvoiceVO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getInvoiceVOPeople() == null ? other.getInvoiceVOPeople() == null : this.getInvoiceVOPeople().equals(other.getInvoiceVOPeople()))
            && (this.getIdentityNumber() == null ? other.getIdentityNumber() == null : this.getIdentityNumber().equals(other.getIdentityNumber()))
            && (this.getInvoiceVODate() == null ? other.getInvoiceVODate() == null : this.getInvoiceVODate().equals(other.getInvoiceVODate()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getInvoiceVOPeople() == null) ? 0 : getInvoiceVOPeople().hashCode());
        result = prime * result + ((getIdentityNumber() == null) ? 0 : getIdentityNumber().hashCode());
        result = prime * result + ((getInvoiceVODate() == null) ? 0 : getInvoiceVODate().hashCode());
