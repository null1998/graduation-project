...
public class CodeGenerator {
    ...
    public static final String CONTROLLER_URL="/abc";
    public static final String ENTITY_NAME="ABC";
    public static final String ENTITY_NAME_CAMEL_CASE="aBC";
    public static final String ENTITY_NAME_CHINESE="你好";
